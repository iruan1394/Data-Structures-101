...
function stackGraph(num){
    ...
    switch(num) {
        ...
        document.getElementById("stackexp").innerHTML = "Accessing the top element of a stack is instantaneous, and its runtime is unaffected by the stack's size. However, in order to access any other element within the stack, elements need to be popped until the target reaches the top of the stack. Once its value is known, the elements that were previously popped out need to be pushed back in. This process will take longer if the target element is near the bottom of the stack or if the stack simply contains a lot of elements. This is because more elements will need to be popped and pushed back in.";
        break;
        ...
        document.getElementById("stackexp").innerHTML = "Since the elements in a stack are not sorted according to their values, the only way to find a specific element is to keep popping from the stack until either the target is found or the stack becomes empty. Once one of these two outcomes occurs, all the popped elements need to be pushed back in. As such searching for an element in a stack will take longer as the stack grows since more elements need to be checked, popped, and pushed.";
        break;
        ...
        document.getElementById("stackexp").innerHTML = "Stacks do not allow for direct insertion at anywhere besides the top. In order to insert an element at the bottom, every element in the stack needs to be popped out. After that, the element that needs to be inserted can be pushed in as it would become the top of the stack. Finally, every element that had been popped out needs to be pushed back in. This is obviously an extremely costly process and will take longer if the stack is large since more elements will need to be popped and pushed.";
        break;
        ...
        document.getElementById("stackexp").innerHTML = "Inserting an element to the top of stack is quick and simple. All that needs to be done is push the element you want inserted. This function will always take the same amount of time regardless of the stack's size.";
        break;
        ...
        document.getElementById("stackexp").innerHTML = "Stacks excel at operations performed at the top. Top deletion is just another name for popping. Popping takes constant time regardless of the size of the stack.";
        break;  
